...
var ReactCropper = React.forwardRef(function (_a, ref) {
    ...
    var imageProps = React.useMemo(function () { return (__assign(__assign({}, rest), { crossOrigin: crossOrigin, src: src, alt: alt })); }, [rest, crossOrigin, src, alt]);
    return (React.createElement("div", { style: style, className: className },
        React.createElement("img", __assign({}, imageProps, { style: REQUIRED_IMAGE_STYLES, ref: combinedRef }))));
});

export { ReactCropper as Cropper, ReactCropper as default };
